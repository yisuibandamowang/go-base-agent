...
type KnowledgeDocument struct {
	...
	ChunkConfig        db.JSONText `gorm:"column:chunk_config;type:jsonb" json:"chunkConfig"`
	IngestionSpec      db.JSONText `gorm:"column:ingestion_spec;type:jsonb" json:"ingestionSpec"`
